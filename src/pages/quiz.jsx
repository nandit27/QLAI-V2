      ...
      <main className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <header className="text-center mb-16 max-w-3xl mx-auto">
          <motion.h1
            ...
            className="text-5xl md:text-6xl font-extrabold tracking-tight text-white mb-6 leading-tight"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              {/* Toggle Switch */}
              <div className="bg-[#0a0a0a] p-2 rounded-full flex gap-2 w-fit mx-auto lg:mx-0 border border-white/10 mb-8">                <Button
                type="button"
                onClick={() => handleModeChange('youtube')}
                className={`flex items-center gap-2 px-8 py-3 rounded-full font-bold transition-all ${selectedMode === 'youtube'
              ...
              >
                ...
                <Button
                  ...
                  className={`flex items-center gap-2 px-8 py-3 rounded-full font-bold transition-all ${selectedMode === 'document'
                    ? "bg-[#0a0a0a] text-white shadow-sm"
                    : "text-slate-500 hover:bg-slate-200"
                    }`}
                >
              ...
              {/* Main Input Card */}
              <div className="bg-[#0a0a0a] backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-[0_24px_48px_rgba(26,28,31,0.06)] border border-white/10 ">
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <input
                            ...
                            className="w-full bg-neutral-900 border-none rounded-full py-5 pl-14 pr-6 text-white placeholder:text-slate-400 focus:ring-2 focus:ring-[#95ff00] transition-all"
                          />
                        </div>
                      </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full bg-neutral-900 border-none rounded-full py-5 pl-14 pr-6 text-white focus:ring-2 focus:ring-[#95ff00] transition-all"
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <Button
                              ...
                              className={`w-full bg-neutral-900 border-none rounded-full py-5 pl-14 pr-6 text-left flex items-center justify-between transition-all relative z-0 ${isDropdownOpen ? 'ring-2 ring-[#95ff00]' : ''}`}
                              variant="ghost"
                              size="icon">
                              <span className={selectedDifficulty ? "text-white capitalize" : "text-slate-400"}>
                            ...
                            <AnimatePresence>
                              {isDropdownOpen && (
                                <motion.div
                                  ...
                                  className="absolute top-full left-0 right-0 mt-2 bg-[#0a0a0a] rounded-2xl shadow-xl border border-white/10 overflow-hidden z-20"
                                >
                                  {['easy', 'medium', 'hard'].map((level) => (
                                    <Button
                                      ...
                                      className={`w-full text-left px-6 py-4 hover:bg-[#0a0a0a] transition-colors capitalize ${selectedDifficulty === level ? 'bg-[#0a0a0a] text-[#95ff00] font-bold' : 'text-slate-700'}`}
                                      variant="ghost"
                                      size="icon">
                                      {level}
                                    </Button>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <Button
                            ...
                            className={`w-full bg-neutral-900 border-none rounded-full py-5 pl-14 pr-6 text-left flex items-center justify-between transition-all relative z-0 ${isModelDropdownOpen ? 'ring-2 ring-[#95ff00]' : ''}`}
                            variant="ghost"
                            size="icon">
                              ...
                              >
                                {['chatgroq', 'gemini'].map((model) => (
                                  <Button
                                    ...
                                    className={`w-full text-left px-6 py-4 hover:bg-[#0a0a0a] transition-colors ${selectedModel === model ? 'bg-[#0a0a0a] text-[#95ff00] font-bold' : 'text-slate-700'}`}
                                    variant="ghost"
                                    size="icon">
                                    {model}
                                  </Button>
                        ...
                        <div>
                          ...
                          <div
                            ...
                            className={`border-2 border-dashed rounded-2xl p-10 text-center transition-all duration-300 cursor-pointer ${isDragging
                              ...
                              : 'border-slate-300 bg-[#0a0a0a] hover:border-[#95ff00]'
                              }`}
                          >
                            <input
                              id="file-upload"
                            ...
                            <div className="flex flex-col items-center gap-4">
                              ...
                              <p className="text-gray-400 font-medium">Drag & drop PDFs or PPTs here, or <span className="text-primary font-bold">click to browse</span></p>
                            </div>
                          </div>
                          ...
                          {uploadedFiles.length > 0 && (
                            <div className="mt-4 space-y-2">
                              {uploadedFiles.map((file, index) => (
                                <div key={index} className="flex items-center justify-between bg-neutral-900 rounded-xl p-4">
          ...
          <div className="lg:col-span-5 space-y-8 h-full">
            <div className="!bg-[#0a0a0a] backdrop-blur-lg p-8 rounded-3xl relative overflow-hidden flex flex-col min-h-[400px] border border-white/10 shadow-2xl">     <div className="relative z-10 w-full mb-8">
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="font-bold text-white text-xl">Recent Quizzes</span>
              </div>
              <div className="space-y-3 max-h-56 overflow-y-auto custom-scrollbar">
                {loadingRecentQuizzes ? (
                  ...
                  recentQuizzes.map((quiz, i) => (
                    <div key={i} onClick={() => handleRecentQuizSelect(quiz)} className="text-sm text-gray-400 flex justify-between items-center py-3 border-b border-white/10 last:border-0 cursor-pointer hover:text-white transition-colors group bg-[#0a0a0a] px-4 rounded-xl mb-2 shadow-sm border">
                      <span className="truncate font-medium flex-1 pr-4">{quiz.topic || "Untitled Quiz"}</span>
                      <div className="flex flex-col items-end gap-1 shrink-0">
                        <span className="text-[10px] font-bold bg-neutral-900 px-2 py-1 rounded inline-block whitespace-nowrap">
              ...
              <div className="mt-auto relative z-10 w-full pt-8 border-t border-white/10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-white">Join a Quiz</h2>
                </div>
                <QuizJoinSection />
              </div>
    ...
    <div className="space-y-4">
      <div className="relative">
        <input
          ...
          className="w-full bg-neutral-900 border-none rounded-full py-5 px-6 text-white placeholder:text-slate-400 focus:ring-2 focus:ring-[#95ff00] transition-all"
