            ...
            titleComponent={
                <div className="space-y-4 px-4">
                    ...
                    <p className="text-gray-400 text-base md:text-lg max-w-2xl mx-auto">
                        Summarise, quiz, map, and master any video in minutes.
                    </p>
                </div>
            }
        >
            <div className="min-h-screen bg-[#f9f9fd] text-white pt-32 pb-12 font-sans transition-colors duration-300 overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <header className="mb-16">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <span className="text-gray-400 font-bold text-sm">Key Concepts & Findings</span>
                        </div>
                        <motion.h1
                            initial={{ opacity: 0, y: -20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.5 }}
                            className="text-5xl md:text-7xl font-extrabold tracking-tighter text-white leading-tight mb-8"
                        >
                            Interactive <br /><span className="text-[#95ff00]">{quizTitle || "Video Summary"}</span>
                        </motion.h1>
                        <motion.button
                            onClick={() => navigate("/quiz")}
                            className="inline-flex items-center px-6 py-3 bg-[#0a0a0a] border border-white/10 rounded-full hover:bg-neutral-900 :bg-white/10 font-bold text-white transition-all duration-300"
                    ...
                    <AnimatePresence>
                        {showSummary && summaryData && (
                            ...
                            >
                                ...
                                <motion.div
                                    className="bg-[#0a0a0a] border border-white/10 shadow-[0_40px_40px_-20px_rgba(45,47,50,0.04)] rounded-3xl p-8 lg:p-12 mb-12"
                                ...
                                >
                                    ...
                                    <div className="pt-8 border-t border-white/10 ">
                                        <h3 className="text-lg font-bold text-white #95ff00] mb-4">
                                            Key Takeaways
                                        </h3>
                                ...
                                <div className="columns-1 md:columns-2 xl:columns-3 gap-6">
                                    {summaryData.key_concepts.map((concept, index) => (
                                        <motion.div
                                            key={index}
                                            className="break-inside-avoid mb-6 bg-[#0a0a0a] p-8 rounded-3xl shadow-[0_40px_40px_-20px_rgba(45,47,50,0.04)] border border-white/10 hover:scale-[1.01] transition-transform duration-300"
                                            initial={{ y: 20, opacity: 0 }}
                                            animate={{ y: 0, opacity: 1 }}
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-8">
                                                {concept.key_points.map((point, idx) => (
                                                    <span key={idx} className="bg-neutral-900 text-white px-3 py-1 rounded-full text-xs font-bold">
                                                        {point}
                                                    </span>
                                                ))}
                                            </div>
                                            ...
                                            {/* Video Section */}
                                            <div className="mt-8 pt-4 border-t border-white/10 flex justify-between items-center" style={{ pointerEvents: 'auto' }}>
                                                <div>
                                                ...
                                                <Button
                                                    ...
                                                    className="flex items-center justify-center w-12 h-12 bg-neutral-900 rounded-full hover:bg-[#95ff00] hover:text-black :bg-[#95ff00] :text-black transition-colors duration-300 transform hover:scale-105 active:scale-95 text-white "
                                ...
                                {hasArtifacts && (
                                    <motion.div
                                        className="rounded-3xl border border-white/10 bg-[#0a0a0a] p-8 shadow-sm"
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-3 flex flex-wrap gap-2">
                                                    {artifactTypes.map((artifactType) => (
                                                        <span
                                                            key={artifactType}
                                                            className="rounded-full border border-white/10 bg-neutral-900 px-3 py-1 text-xs text-gray-200 font-bold"
                                                        >
                                                            {artifactType}
                                                        </span>
                                                    ))}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        {[
                            ...
                            <motion.div
                                key={index}
                                className="relative bg-[#0a0a0a] border border-white/10 rounded-3xl p-6 cursor-pointer overflow-hidden group hover:shadow-xl :shadow-none transition-all duration-300"
                            ...
                            >
                                <div className="relative z-10 flex flex-col h-full">
                                    <div className="w-14 h-14 bg-neutral-900 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#95ff00] group-hover:text-black transition-colors duration-300 text-slate-700 ">
                                        {action.icon}
                                    </div>
                                    <h3 className="text-xl font-extrabold text-white mb-2 transition-colors duration-300 line-clamp-1">
                                        {action.title}
                                    </h3>
                    ...
                    {hasArtifacts && !artifactDrawerOpen && (
                        <motion.button
                            type="button"
                            onClick={() => setArtifactDrawerOpen(true)}
                            className="fixed right-0 top-1/2 z-40 flex -translate-y-1/2 items-center gap-3 rounded-l-2xl border border-[#95ff00]/30 bg-slate-950/95 px-3 py-4 shadow-[0_20px_60px_rgba(8,145,178,0.22)] backdrop-blur"
                            initial={{ x: 24, opacity: 0 }}
                            animate={{ x: 0, opacity: 1 }}
                            whileHover={{ x: -4 }}
                        >
                            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#95ff00]/10 text-cyan-300">
                            ...
                            <div className="hidden text-left sm:block">
                                ...
                                <div className="text-sm font-medium text-white ">Open visual lab</div>
                            </div>
                        </motion.button>
                    )}
                    ...
                    <AnimatePresence>
                        {hasArtifacts && artifactDrawerOpen && (
                            <>
                                ...
                                />
                                <motion.aside
                                    className="fixed right-0 top-0 z-50 flex h-screen w-full max-w-2xl flex-col border-l border-[#95ff00]/20 bg-slate-950/96 shadow-[0_30px_80px_rgba(15,23,42,0.7)]"
                                    initial={{ x: "100%" }}
                                    animate={{ x: 0 }}
                                    exit={{ x: "100%" }}
                                    transition={{ type: "spring", damping: 28, stiffness: 220 }}
                                >
                                    <div className="border-b border-[#95ff00]/15 bg-gradient-to-r from-[#95ff00]/10 via-slate-950 to-pink-500/10 px-5 py-5">
                                        <div className="flex items-start justify-between gap-4">
                                            <div>
                                                <p className="text-[11px] font-semibold uppercase tracking-[0.24em] currentcolor/75">
                                                    Visual Lab
                                                </p>
                                                <h3 className="mt-1 text-2xl font-semibold text-white ">Summary artifacts</h3>
                                            ...
                                            <Button
                                                type="button"
                                                onClick={() => setArtifactDrawerOpen(false)}
                                                className="flex h-11 w-11 items-center justify-center rounded-2xl border border-[#95ff00]/20 bg-slate-900/80 text-slate-300 transition hover:bg-slate-800"
                                                variant="ghost"
                                                size="icon">
                                                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <AnimatePresence>
                        {showVideoPopup && selectedConcept && (
                            ...
                            >
                                <motion.div
                                    className="bg-gray-900 border border-[#95ff00]/30 rounded-2xl p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto"
                                            ...
                                            <ul className="space-y-2 text-gray-200">
                                                {selectedConcept.key_points.map((point, idx) => (
                                                    <li key={idx} className="flex items-start">
                                                        <span className="w-2 h-2 bg-[#95ff00] rounded-full mr-3 mt-2 flex-shrink-0"></span>
                                                        <span>{point}</span>
                                                    </li>
                                                ))}
                                            </ul>
